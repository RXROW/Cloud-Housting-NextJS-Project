...
const UpdateCommentModal = ({
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 z-10000 bg-black bg-opacity-40 flex items-center justify-center">
      <div className="w-11/12 lg:w-2/4 bg-white rounded-lg p-3">
        ...
        <form onSubmit={formSubmitHandler}>
          <input
            ...
            className="text-xl rounded-lg p-2 w-full bg-white mb-2 border"
            value={updatedText}
            onChange={(e) => setUpdatedText(e.target.value)}
          />
          <button
            type="submit"
            className="bg-blue-700 w-full text-white mt-2 p-1 text-xl rounded-lg hover:bg-blue-900 transition"
          >
            Edit
          </button>
        </form>
